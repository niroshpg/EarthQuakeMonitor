...
/**
 * Manages "Authentication" to EarthQuakeMonitor's backend service.  The SyncAdapter framework
 ...
 */
public class EarthQuakeAuthenticator extends AbstractAccountAuthenticator {

    public EarthQuakeAuthenticator(Context context) {
        super(context);
    }
